...
updatedAt: "2023-01-09T16:50:24.687Z"
---
...
| `timestamp_per_label` | boolean | Enhance other skills-generated labels with the corresponding timestamp of the words in the label                                                                            | `true`    |
...
| `engine`              | string  | Either `default` or `whisper`. Determines which transcription engine to use. `default` is the premium OneAI transcription service while `whisper` is an open-source engine. | `default` |
